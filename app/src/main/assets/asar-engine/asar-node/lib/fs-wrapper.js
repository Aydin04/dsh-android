...
const bufferToString = (maybeBuffer) => {
  if (Buffer.isBuffer(maybeBuffer)) return maybeBuffer.toString();
  if (maybeBuffer instanceof URL || (typeof maybeBuffer === "object" && maybeBuffer && maybeBuffer.href)) {
    return fileURLToPath(maybeBuffer);
  }
  return maybeBuffer;
};
